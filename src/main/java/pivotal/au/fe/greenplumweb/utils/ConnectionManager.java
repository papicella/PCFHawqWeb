...
public class ConnectionManager 
{
	...
	private Map<String,GreenplumJDBCConnection> conList = new HashMap<String,GreenplumJDBCConnection>();
	...
	public void addConnection (GreenplumJDBCConnection conn, String key)
	{
	...
	{
		GreenplumJDBCConnection sqlfireConn = conList.get(key);
	...
	public Map <String,GreenplumJDBCConnection> getConnectionMap()
	{
		return conList; 
	}
